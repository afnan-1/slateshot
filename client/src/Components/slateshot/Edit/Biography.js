            ...
            <div className="bg-white p-3 widget shadow rounded mb-4">
                ...
                <div className=" row mt-3">
                    {props.user.excerpts ? props.user.excerpts.map((v, i) => {
                        return <React.Fragment key={i}>
                            <BiographyThumbnail excerptsTitle={v[0]} keyexcerpts={i} audio={v[1]} excerpts={v[2]} email={props.user.email} />
                        </React.Fragment>
                    }) : ''}
            ...
            <div className="bg-white p-3 widget shadow rounded mb-4">
                ...
                <div className=" row mt-3">
                    ...
                    {props.user.voiceover ? props.user.voiceover.map((v, i) => {
                        return <React.Fragment key={i}>
                            <BiographyThumbnail voiceoverTitle={v[0]} keyvoiceover={i} audio={v[1]} email={props.user.email} />
                        </React.Fragment>
                    }) : ''}
